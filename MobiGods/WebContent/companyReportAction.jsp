...
companyBean.setF_date(from);
companyBean.setL_date(to);
companyBean.setC_id(c_id);
ArrayList<CompanyBean> cb=LoginDAO.reportViewCompany(companyBean);
  ...
  <div class="site-wrap">
	...
	<table bgcolor="white" align="center">
								...
								<tr>
									...
									<td width="43" align="center"><div align="center">
											<span style="font-size: 14"><%=it.getC_id()%></span>
										</div></td>
									<td width="43" align="center"><div align="center">
											<span style="font-size: 14"><%=it.getP_name() %></span>
										</div></td>
									<td width="43" align="center"><div align="center">
											<span style="font-size: 14"><%=it.getPrice()%></span>
										</div></td>
									<td width="43" align="center"><div align="center">
											<span style="font-size: 14"><%=it.getType() %></span>
										</div></td>
									<td width="43" align="center"><div align="center">
											<span style="font-size: 14"><%=it.getO_date() %></span>
										</div></td>
